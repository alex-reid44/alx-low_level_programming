...
File lists.h is the header file containing all these function prototypes and the data structure listint_t.A repository for all our low-level programming tasks
